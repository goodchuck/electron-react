...
import {scene, cube,camera,renderer} from '../JS/object.js';
...
class TransformationTool {
    ...
    initializeFocusHandles(){
        ...
        for(let handleName of Object.keys(this.focusHandles)){
            ...
            pickSphere.addEventListener("click", e => {
                ...
                let alignment = new THREE.Vector3(...handle.alignment).multiplyScalar(6 * maxScale / handleLength);
                ...
                moveTo(scene, newCamPos, newCamTarget);
            });
    ...
    update() {
        ...
        for(let handleName of Object.keys(this.handles)){
            ...
            let scale = new THREE.Vector3(cube.scale.x,cube.scale.y,cube.scale.z);
...
function moveTo(scene, endPosition, endTarget){
    console.log("실행",TWEEN,camera,cube)
    // let view = scene.view;
